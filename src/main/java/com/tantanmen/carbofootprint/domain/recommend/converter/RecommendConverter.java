...
public class RecommendConverter {
	...
	public static RecommendResponseDto.RecommendFoodResponseDto toRecommendFoodResponseDto(List<FoodRecommend> foodRecommendList, List<AllergenType> allergenTypeList, List<PreferenceType> preferenceTypeList){
